...
public class ScreenUtils {
    ...
    public static final String KEY_HABIT_TITLE = "noti_title";
    ...
    // to calculate dp from pixels in android programmatically [duplicate]
    // following is to get resolution and then to calculate
    ...
    public static void hideKeyboardWithNoFlags(Context ctx) {
        ...
        if (v == null)
            return;
        if (inputManager != null) inputManager.hideSoftInputFromWindow(v.getWindowToken(), 0);
    }
    ...
    // to calculate pixels from dpi in android programmatically [duplicate]
    /**
     * Get pixel from dpi.
     *
     * @param dpi
